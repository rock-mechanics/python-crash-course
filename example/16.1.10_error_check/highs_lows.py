...
with open(fname) as f : 
    ...
    # enumerate also starts from the cursor position and automatically index it as zero
    # pass in the start argument and change the starting index
    for index, row in enumerate(reader, start=2) : 
        ...
        try : 
            ...
            print('row {} : missing data'.format(index))
        else : 
            highs.append(high)
            dates.append(date)
            lows.append(low)
