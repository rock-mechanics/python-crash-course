...
def run_game() : 
    ...
    while True : 
        ...
        if stats.game_active : 
            ...
            gf.update_aliens(aliens, settings, ship, stats, screen, bullets, score)
        ...
        # make sure all frames are same time
        # it will compute the differnces between while loops and make sure they are compensated
        # the argument is set as 'frames per second'
