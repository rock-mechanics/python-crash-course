...
frequencies = [results.count(value) for value in range(1, die1.sides * die2.sides + 1)]
...
# setting the x label
bar.x_labels = [str(i) for i in range(1, die1.sides * die2.sides + 1)]
# add the data
bar.add('multiply of two dice', frequencies)
