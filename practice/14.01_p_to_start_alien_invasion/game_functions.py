...
def check_events(ship, bullets, settings, stats, button, screen, aliens) : 
    ...
    for event in pygame.event.get() : 
        if event.type == pygame.QUIT : 
            ...
            check_key_down_events(event, settings, ship, bullets, stats, aliens, screen)
...
def check_play_button(stats, button, mouse_x, mouse_y, screen, aliens, bullets, settings, ship) : 
    ...
    if button_clicked and not stats.game_active : 
        start_game(stats, aliens, bullets, ship, settings, screen) 

def start_game(stats, aliens, bullets, ship, settings, screen) : 
        ''' start the game '''
...
def check_key_down_events(event, settings, ship, bullets, stats, aliens, screen) : 
